...
BOOST_AUTO_TEST_CASE(bzz_hash_short)
{
	...
	BOOST_CHECK_EQUAL(bzzHashHex(bytes(1, 0)), "fe60ba40b87599ddfb9e8947c1c872a4a1a5b56f7d1b80f0a646005b38db52a5");
...
BOOST_AUTO_TEST_CASE(bzz_hash_large)
{
	...
	BOOST_CHECK_EQUAL(bzzHashHex(bytes(4096 * 128 * 2, 0)), "f89af84ac550cdaa79639d5f6a1591ff1c9b3cb5d1fc55651ca63d4f80375447");
	BOOST_CHECK_EQUAL(bzzHashHex(bytes(4096 * 129, 0)), "8ab36734a15aef65221b024e47ee9a6bb727d8101eec42db364eef42285beb1d");
	BOOST_CHECK_EQUAL(bzzHashHex(bytes(4096 * 130, 0)), "21eafb87f2a2a7e51d96212296f8e970103add0527f2fc61fae99f244847a42d");
}

BOOST_AUTO_TEST_CASE(bzz_hash_nonzero)
{
	BOOST_CHECK_EQUAL(bzzHashHex(sequence(65)), "541552bae05e9a63a6cb561f69edf36ffe073e441667dbf7a0e9a3864bb744ea");
	BOOST_CHECK_EQUAL(bzzHashHex(sequence(4096)), "c10090961e7682a10890c334d759a28426647141213abda93b096b892824d2ef");
	BOOST_CHECK_EQUAL(bzzHashHex(sequence(4096 * 128 + 31)), "e5c76afa931e33ac94bce2e754b1bb6407d07f738f67856783d93934ca8fc576");
	BOOST_CHECK_EQUAL(bzzHashHex(sequence(4096 * 128 + 33)), "c2489aebad937b19384b61c7bd4ba494f9b14a710b2bcccce792856fb8fcfb3d");
	BOOST_CHECK_EQUAL(bzzHashHex(sequence(4096 * 129)), "b7e298f61b1bf23e21d8f45bf545eb1d6c0c4eaaca7d2c2690fb86038404a6d6");
	BOOST_CHECK_EQUAL(bzzHashHex(sequence(4096 * 130)), "59de730bf6c67a941f3b2ffa2f920acfaa1713695ad5deea12b4a121e5f23fa1");
}
